# Parchments: The Ultimate Scripture Study Workspace

Welcome to **Parchments**, a premium, offline-first study environment designed for deep scriptural research, composition, and spiritual reflection. This guide will walk you through the entire workspace and its powerful intelligence tools.

---

## 🚀 Getting Started

When you first open Parchments, you'll find a clean workspace. To begin your study:
1.  **Note Creation**: Click the "New Note" or "New Voice Note" button in the Top Bar.
2.  **Bible Import**: Go to **Settings > Downloads** to fetch your favorite translations. Parchments supports adaptive ingestion of local Bible data, meaning it learns to read new formats automatically.
...
2.  Choose from **PDF**, **Word (.docx)**, **Markdown**, **HTML**, or **Plain Text**.
3.  Customize options like including titles or dates in the final document.
