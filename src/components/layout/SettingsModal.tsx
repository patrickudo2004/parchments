...
const TABS = [
    ...
    { id: 'bible', label: 'Bible & Study', icon: MenuBookIcon },
                                ...
                                >
                                    ...
                                    {activeTab === 'bible' && (
                                        <>
                                            <section className="space-y-4">
                                                ...
                                                <div className="max-w-md">
                                                    <select
                                                        ...
                                                        className="w-full p-2.5 bg-light-background dark:bg-dark-background border border-light-border dark:border-dark-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
                                                    >
                                            ...
                                            <section className="space-y-4">
                                                <h4 className="text-sm font-bold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">Bible Import</h4>
                                                <div className="p-4 border-2 border-dashed border-light-border dark:border-dark-border rounded-xl flex flex-col items-center justify-center gap-4 text-center group hover:border-primary/50 transition-colors">
                                                    <div className="w-12 h-12 bg-light-background dark:bg-dark-background rounded-full flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                                                        <CloudUploadIcon className="text-light-text-secondary group-hover:text-primary" />
                                                    </div>
                                                    <div>
                                                        <p className="text-sm font-bold">Import Custom Bible Version</p>
                                                        <p className="text-xs text-light-text-disabled mt-1">Supports SQLite, XML, and JSON formats</p>
                                                    </div>
                                                    <button className="px-6 py-2 bg-primary text-white rounded-lg text-sm font-bold shadow-md hover:bg-primary-hover transition-colors">Choose File</button>
                                                </div>
                                            </section>
                                            ...
                                            <section className="space-y-4">
                                                <div className="flex items-center justify-between p-4 bg-light-background dark:bg-dark-background rounded-xl border border-light-border dark:border-dark-border">
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-light-text-secondary">Show floating preview when hovering linked references</p>
                                                    </div>
                                                    <button
                                                        onClick={() => updateSettings({ verseHoverPreviews: !settings.verseHoverPreviews })}
                                                        className={`w-12 h-6 rounded-full p-1 transition-all flex items-center ${settings.verseHoverPreviews ? 'bg-primary' : 'bg-gray-300 dark:bg-gray-700'}`}
                                                    >
